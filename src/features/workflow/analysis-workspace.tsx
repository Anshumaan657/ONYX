...
export function AnalysisWorkspace() {
  const [step, setStep] = useState<"import" | "setup" | "results" | "policies">("import");
  ...
  function imported(summary: MmsImportSummary, client: HistoricalAnalysisClient) { setSource(summary); setAnalysisClient(client); }
  function resetSource() { setSource(null); setAnalysisClient(null); }
  return <main className="mx-auto min-h-screen w-full max-w-[1280px] px-4 py-5 sm:px-8">
    ...
    <div hidden={step !== "import"}>
      ...
      <MmsImporter onReady={imported} onReset={resetSource} onContinue={() => setStep("results")} />
